						...
						<Navbar.Header>
						    <Navbar.Brand>
						      <a href='#' className='app-logo'>
						      	<img src='../img/logo-4.png' className='logo-img'/>
						      </a>
								...
								<NavDropdown className = 'header-dropdown'
								  ...
								  eventKey={3} title="Programs" id="basic-nav-dropdown">
									<MenuItem className='dropdown-content' eventKey={3.1}><NavLink exact activeClassName='activeNav' to='/programs/daycare'>Day Care</NavLink></MenuItem>
	      							...
	      							<MenuItem className='dropdown-content' eventKey={3.2}><NavLink exact activeClassName='activeNav' to='/programs/summer-program'>Summer Programs</NavLink></MenuItem>
								</NavDropdown>
