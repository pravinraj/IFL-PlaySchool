			...
			<Col xs={12} className='about-wrapper'>
				...
				<Col xs={12} className='about-contents'>
					...
					<Col xs={6} className='about-contents-data'>
						...
						<p>We, Fun Toddz, have ample inside and outside space which lets the child play and learn through play.  Our center has both traditional and newest play equipments. The ambience at our center provides plenty of fresh air, light and ventilation.</p>
